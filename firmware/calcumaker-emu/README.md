...
The glass **rounds to its 16 digits** like a real HP (`382.1` shows as `382.1`,
never `382.09999…` spilling off the row); the `X:` line underneath is the SHOW
view — the register at full precision.
