...
wiring; regen reassigns UUIDs). 0402 passives; bulk caps 0805. Verify each
...
PSU = dict(name="PSU", file="psu.kicad_sch",
    ...
    small=[
        ...
        C("C1", "10uF", C0805), C("C2", "10uF", C0805),  # charger in/out
        ...
        C("C3", "10uF", C0805), C("C4", "10uF", C0805), C("C5", "10uF", C0805),
        C("C6", "10uF", C0805), C("C7", "10uF", C0805),
